  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className="fixed inset-0 z-50 bg-brand-dark/40 backdrop-blur-[2px]" />
        ...
        >
          ...
          <DialogPrimitive.Close
            className="absolute right-4 top-4 flex size-9 items-center justify-center rounded-full text-muted transition hover:bg-brand-soft hover:text-brand-dark"
            aria-label="关闭"
          >
            <X className="size-4" />
          </DialogPrimitive.Close>
