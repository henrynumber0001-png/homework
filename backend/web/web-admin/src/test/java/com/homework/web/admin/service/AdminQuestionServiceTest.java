...
class AdminQuestionServiceTest {
    ...
    void movingInterviewQuestionUpShiftsIntermediateQuestionsBack() {
        ...
        when(bankMapper.updateVersion(11L, 4)).thenReturn(1);
        when(interviewQuestionMapper.parkQuestionNo(11L, 88L, 8)).thenReturn(1);
        when(interviewQuestionMapper.negativeQuestionNoRange(11L, 3, 7)).thenReturn(5);
        ...
        verify(interviewQuestionMapper).negativeQuestionNoRange(11L, 3, 7);
    ...
    void movingCertificateQuestionDownShiftsIntermediateQuestionsForward() {
        ...
        when(bankMapper.updateVersion(22L, 9)).thenReturn(1);
        when(certificateQuestionMapper.parkQuestionNo(22L, 33L, 3)).thenReturn(1);
        when(certificateQuestionMapper.negativeQuestionNoRange(22L, 4, 8)).thenReturn(5);
        ...
        verify(certificateQuestionMapper).negativeQuestionNoRange(22L, 4, 8);
    ...
    void unchangedQuestionNumberDoesNotBumpBankVersion() {
        ...
        verify(bankMapper, never()).updateVersion(11L, 6);
    ...
    void deletingQuestionCompactsFollowingQuestionNumbers() {
        ...
        deleted.setStatus(QuestionInfoStatus.DELETED);
        ...
        when(interviewQuestionMapper.logicalDelete(11L, 55L, 2, QuestionInfoStatus.DELETED)).thenReturn(1);
        when(interviewQuestionMapper.selectMaxQuestionNo(11L)).thenReturn(8);
        when(interviewQuestionMapper.negativeQuestionNoRange(11L, 4, 8)).thenReturn(5);
        when(interviewQuestionMapper.restoreQuestionNoRange(11L, 4, 8, -1)).thenReturn(5);
        when(bankMapper.updateVersion(11L, 12)).thenReturn(1);
